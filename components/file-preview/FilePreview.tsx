...
// New inline component for use in tabs
...
export function FilePreviewContent({ file, onClose, className = "" }: FilePreviewContentProps) {
      ...
      case 'image':
        return (
          <div className="relative flex items-center justify-center min-h-[400px] bg-gray-900 rounded-lg overflow-hidden">
            <img
              src={file.url || file.content || '/placeholder-image.jpg'}
              alt={file.name}
  ...
  return (
    <div className={cn("bg-gradient-to-br from-slate-900 via-purple-950 to-slate-900 text-white h-full flex flex-col", className)}>
      {/* Header */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-purple-500/20 rounded-lg flex items-center justify-center">
              {(() => { const Icon = getFileIcon(); return <Icon className="w-5 h-5 text-purple-400" /> })()}
            </div>
            <div>
